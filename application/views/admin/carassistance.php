...
<body class="hold-transition sidebar-mini">
                    ...
                    <div class="card">
                            ...
                            <div class="modal fade " id="TambahData" data-backdrop="static" data-keyboard="false"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form action="CarAssistance/SimpanData" method="POST">
                                            <div class="modal-body ">
                                                <div class="row">
                                                    <div class="form-group col-md-6">
                                                        <label class="col-form-label"> Nama :</label>
                                                        <input class="form-control" type="text" value=""
                                                            name="namaPmobil" required>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label class="col-form-label"> Max Penumpang :</label>
                                                        <input class="form-control" type="text" value=""
                                                            name="JumlahPenumpang" required>
                                                    </div>
                                                </div>
                        ...
                        <div class="card-body table-responsive">
                            <table id="dataTable" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php $no = 1;
                                    foreach ($getCarAll->result() as $row) { ?>
                                    <tr>
                                        <td><?php echo $no; ?></td>
                                        <td><?php echo $row->namaPmobil; ?></td>
                                        <td><?php echo $row->tgl; ?></td>


                                        <td>
                                            <a href="" class="btn btn-info btn-sm" data-toggle="modal"
                                                data-target="#editData" data-id="<?= $row->idPmobil; ?>">
                                                <i class="nav-icon  fas fa-edit"></i>
                                            </a>
                                            <?php if ($row->statusM == '3') { ?>
                                            <?php } else if ($row->statusM == '1') { ?>
                                            <a href="CarAssistance/HapusData/<?= $row->idPmobil; ?>"
    ...
    <!-- Modal -->
    <div class="modal fade " id="editData" data-backdrop="static" data-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="CarAssistance/SimpanUbah" method="POST">
                    <div class="modal-body isiEditCarAssistance">
                    </div>
                    <div class="modal-footer">
    ...
    $('#editData').on('show.bs.modal', function(e) {
        ...
        $.ajax({
            type: 'post',
            url: "<?php echo base_url(); ?>CarAssistance/GetmobilId",
            data: {
                id: id
            },
            success: function(data) {
                $('.isiEditCarAssistance').html(data);
            }
        });
    });
    </script>
